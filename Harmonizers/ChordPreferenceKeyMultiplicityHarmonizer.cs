...
{
    public class ChordPreferenceKeyMultiplicityHarmonizer() : IMeasureHarmonizer
    {
        ...
        public List<Measure> MeasuresFromVelocities(List<int?[]> velocityMeasures)
        {
            ...
            foreach (var velocityMeasure in velocityMeasures)
            {
                ...
                Scale currentChord = _chordsOfInterest.TakeRandom();
                List<int>[] keyMultiplicity = currentScale.CalculateKeyMultiplicity(currentChord);
